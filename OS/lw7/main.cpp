...
const int DISK_HEADER_SIZE = 16;
const int CLUSTER_MINIMAL_SIZE = 64;
...
int main()
{
	cout << "File system emulator" << endl;
...
void CreateActionMap()
{
	...
	g_actionMap.insert(make_pair("exit", bind(&ExitCommand, _1)));
}
...
void CreateDiskCommand(string &args)
{
	...
	cout << "Disk <" << diskFileName << "> was successfully created" << endl;
}
...
void MountCommand(string &args)
{
	...
	cout << "Disk <" << diskFileName << "> was successfully mounted" << endl;
}
...
void UnMountCommand(string &args)
{
	...
	cout << "Current disk was successfully unmounted" << endl;
}
...
void FormatCommand(string &args)
{
	...
	cout << "Current disk was format successfully" << endl;
}
...
void WriteCommand(string &args)
{
	...
	cout << "File " << fileName << " was write successfully" << endl;
}
...
void ReadCommand(string &args)
{
	...
	cout << "File " << sourceFile << " was read successfully as file " << destFile << endl;
}
...
void DeleteCommand(string &args)
{
	...
	cout << "File " << fileName << " was delete successfully" << endl;
}
...
void SqueezeCommand(string &args)
{
	...
	cout << "Disk data was squeezed successfully" << endl;
}
...
void ExitCommand(string &args)
{
	if (AskUser("Exit from filesys emulator"))
	{
		exit(0);
	}
}
...
void Dir(void *diskData)
{
	...
	do
	{
		...
		cout << setw(15) << left << GetFileNameFromHeader(header);
		cout << header.size << endl;

	} while (offset != INVALID_OFFSET_VALUE);

	cout << endl << right << filesCount << " files   ";
	cout << filesSize << " bytes" << endl;
	cout << freeSpaceSize << " bytes free" << endl;
	cout << "Maximum available memory block " << maxAvailBlockSize << " bytes" << endl;
}
...
void ShowDiskMap(void* diskData)
{
	...
	const unsigned char diskHeadCh = 253;
	const unsigned char fileHeadCh = 4;
	const unsigned char existCh = 219;
	const unsigned char emptyCh = 176;
	const unsigned char unusedCh = 249;
	...
	cout << endl << endl << diskHeadCh << " - disk header   ";
	cout << fileHeadCh << " - block header   ";
	cout << existCh << " - file data" << endl;
	cout << emptyCh << " - empty space   ";
	cout << unusedCh << " - unused space" << endl;
}
