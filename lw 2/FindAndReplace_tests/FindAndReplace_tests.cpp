...
BOOST_AUTO_TEST_SUITE(Find_And_Replace_function)
	...
	BOOST_AUTO_TEST_CASE(it_does_not_search_a_blank_line)
	{
	...
	BOOST_AUTO_TEST_CASE(it_does_not_change_the_original_string_if_the_search_string_is_not_found)
	{
	...
	BOOST_AUTO_TEST_CASE(it_replaces_all_occurrences_of_a_search_string_in_the_word_of_shorter_length)
	{
	...
	BOOST_AUTO_TEST_CASE(it_replaces_all_occurrences_of_the_search_string_word_for_a_greater_length)
	{
		string subject = "Buffalo buffalo Buffalo buffalo buffalo buffalo Buffalo buffalo";
